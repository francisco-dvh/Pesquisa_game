...
import { RecordsItem } from '../Records/types';

export const buildBarSeries = (games: Game[], records: RecordsItem[]) => {
...
export const getPlatformChartData = (records: RecordsItem[]) => {
...
export const getGenderChartData = (records: RecordsItem[]) => {
